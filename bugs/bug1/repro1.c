...
int main(void)
{
  ...
  intptr_t res = 0;
  NONFAILING(memcpy((void*)0x200004c0, "/dev/tty1#\000", 11));
  ...
  NONFAILING(*(uint32_t*)0x20000448 = 0xd);
  NONFAILING(*(uint32_t*)0x2000044c = 0x20);
  NONFAILING(*(uint32_t*)0x20000450 = 0x7c);
  NONFAILING(*(uint64_t*)0x20000458 = 0x20000040);
